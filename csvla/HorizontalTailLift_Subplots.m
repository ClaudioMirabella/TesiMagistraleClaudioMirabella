...
%% SUBPLOT
if n_Mass == 2 
        h1 = openfig('HorizontalTailLift1.fig','reuse'); % open figure
        ax1 = gca; % get handle to axes of figure

        h2 = openfig('HorizontalTailLift2.fig','reuse');
        ax2 = gca;
...
elseif n_Mass == 4 
        ...
        h3 = openfig('HorizontalTailLift3.fig','reuse'); % open figure
        ax3 = gca; % get handle to axes of figure

        h4 = openfig('HorizontalTailLift4.fig','reuse');
        ax4 = gca;
...
elseif n_Mass == 6
        ...
        h5 = openfig('HorizontalTailLift5.fig','reuse'); % open figure
        ax5 = gca; % get handle to axes of figure

        h6 = openfig('HorizontalTailLift6.fig','reuse');
        ax6 = gca;
...
elseif n_Mass == 8
        ...
        h7 = openfig('HorizontalTailLift7.fig','reuse'); % open figure
        ax7 = gca; % get handle to axes of figure

        h8 = openfig('HorizontalTailLift8.fig','reuse');
        ax8 = gca;
...
elseif n_Mass == 10
        ...
        h9 = openfig('HorizontalTailLift9.fig','reuse'); % open figure
        ax9 = gca; % get handle to axes of figure

        h10 = openfig('HorizontalTailLift10.fig','reuse');
        ax10 = gca;
...
% SAVING AS A .FIG
name_figure = "HorizontalTailLiftSubplots";
saveas(figure(n_figure), name_figure, 'fig');

% EXPORT FIGURE
exportgraphics(figure(n_figure), 'HorizontalTailLiftSubplots.pdf', 'ContentType', 'vector')
exportgraphics(figure(n_figure), 'HorizontalTailLiftSubplots.png', 'ContentType', 'vector')

% Moving file inside correct folder
movefile HorizontalTailLiftSubplots.fig Output
movefile HorizontalTailLiftSubplots.pdf Output
movefile HorizontalTailLiftSubplots.png Output 
% -----------------------------------------------------------------