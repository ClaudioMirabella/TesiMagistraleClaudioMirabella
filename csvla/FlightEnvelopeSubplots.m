...
if n_Mass == 2 
        ...
        h2 = openfig('FlightEnvelope2.fig','reuse');
        ax2 = gca;
...
elseif n_Mass == 4 
        ...
        h3 = openfig('FlightEnvelope3.fig','reuse'); % open figure
        ax3 = gca; % get handle to axes of figure

        h4 = openfig('FlightEnvelope4.fig','reuse');
        ax4 = gca;
...
elseif n_Mass == 6
        ...
        h5 = openfig('FlightEnvelope5.fig','reuse'); % open figure
        ax5 = gca; % get handle to axes of figure

        h6 = openfig('FlightEnvelope6.fig','reuse');
        ax6 = gca;
...
elseif n_Mass == 8
        ...
        h7 = openfig('FlightEnvelope7.fig','reuse'); % open figure
        ax7 = gca; % get handle to axes of figure

        h8 = openfig('FlightEnvelope8.fig','reuse');
        ax8 = gca;
...
elseif n_Mass == 10
        ...
        h9 = openfig('FlightEnvelope9.fig','reuse'); % open figure
        ax9 = gca; % get handle to axes of figure

        h10 = openfig('FlightEnvelope10.fig','reuse');
        ax10 = gca;
...
%% SAVING AND MOVING FIGURE IN OUTPUT FOLDER 
% FIND FIGURE NUMBER
h_figure =  findobj('type','figure');
n_figure = h_figure(1,1).Number;

% SAVING AS A .FIG
name_figure = "FlightenvelopeSubplots";
saveas(figure(n_figure), name_figure, 'fig');

% EXPORT FIGURE
exportgraphics(figure(n_figure), 'FlightenvelopeSubplots.pdf', 'ContentType', 'vector')
exportgraphics(figure(n_figure), 'FlightenvelopeSubplots.png', 'ContentType', 'vector')

% Moving file inside correct folder
movefile FlightenvelopeSubplots.fig Output
movefile FlightenvelopeSubplots.pdf Output
movefile FlightenvelopeSubplots.png Output 
% -----------------------------------------------------------------