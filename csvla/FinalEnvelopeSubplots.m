...
if n_Mass == 2 
        ...
        h2 = openfig('FinalEnvelope2.fig','reuse');
        ax2 = gca;
        ...
        title("Combined flight envelope diagram", "Interpreter", "latex")
...
elseif n_Mass == 4 
        ...
        h3 = openfig('FinalEnvelope3.fig','reuse'); % open figure
        ax3 = gca; % get handle to axes of figure

        h4 = openfig('FinalEnvelope4.fig','reuse');
        ax4 = gca;
...
elseif n_Mass == 6
        ...
        h5 = openfig('FinalEnvelope5.fig','reuse'); % open figure
        ax5 = gca; % get handle to axes of figure

        h6 = openfig('FinalEnvelope6.fig','reuse');
        ax6 = gca;
...
elseif n_Mass == 8
        ...
        h7 = openfig('FinalEnvelope7.fig','reuse'); % open figure
        ax7 = gca; % get handle to axes of figure

        h8 = openfig('FinalEnvelope8.fig','reuse');
        ax8 = gca;
...
elseif n_Mass == 10
        ...
        h9 = openfig('FinalEnvelope9.fig','reuse'); % open figure
        ax9 = gca; % get handle to axes of figure

        h10 = openfig('FinalEnvelope10.fig','reuse');
        ax10 = gca;
...
% SAVING AS A .FIG
name_figure = "FinalenvelopeSubplots";
saveas(figure(n_figure), name_figure, 'fig');

% EXPORT FIGURE
exportgraphics(figure(n_figure), 'FinalenvelopeSubplots.pdf', 'ContentType', 'vector')
exportgraphics(figure(n_figure), 'FinalenvelopeSubplots.png', 'ContentType', 'vector')

% Moving file inside correct folder
movefile FinalenvelopeSubplots.fig Output
movefile FinalenvelopeSubplots.pdf Output
movefile FinalenvelopeSubplots.png Output 
% -----------------------------------------------------------------