...
if n_Mass == 2 
        ...
        h2 = openfig('WingBodyLift2.fig','reuse');
        ax2 = gca;
...
elseif n_Mass == 4 
        ...
        h3 = openfig('WingBodyLift3.fig','reuse'); % open figure
        ax3 = gca; % get handle to axes of figure

        h4 = openfig('WingBodyLift4.fig','reuse');
        ax4 = gca;
...
elseif n_Mass == 6
        ...
        h5 = openfig('WingBodyLift5.fig','reuse'); % open figure
        ax5 = gca; % get handle to axes of figure

        h6 = openfig('WingBodyLift6.fig','reuse');
        ax6 = gca;
...
elseif n_Mass == 8
        ...
        h7 = openfig('WingBodyLift7.fig','reuse'); % open figure
        ax7 = gca; % get handle to axes of figure

        h8 = openfig('WingBodyLift8.fig','reuse');
        ax8 = gca;
...
elseif n_Mass == 10
        ...
        h9 = openfig('WingBodyLift9.fig','reuse'); % open figure
        ax9 = gca; % get handle to axes of figure

        h10 = openfig('WingBodyLift10.fig','reuse');
        ax10 = gca;
...
% SAVING AS A .FIG
name_figure = "WingBodyLiftSubplots";
saveas(figure(n_figure), name_figure, 'fig');

% EXPORT FIGURE
exportgraphics(figure(n_figure), 'WingBodyLiftSubplots.pdf', 'ContentType', 'vector')
exportgraphics(figure(n_figure), 'WingBodyLiftSubplots.png', 'ContentType', 'vector')

% Moving file inside correct folder
movefile WingBodyLiftSubplots.fig Output
movefile WingBodyLiftSubplots.pdf Output
movefile WingBodyLiftSubplots.png Output 
% -----------------------------------------------------------------