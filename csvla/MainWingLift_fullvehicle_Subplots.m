...
%% SUBPLOT
if n_Mass == 2 
        h1 = openfig('FullVehicleLift1.fig','reuse'); % open figure
        ax1 = gca; % get handle to axes of figure

        h2 = openfig('FullVehicleLift2.fig','reuse');
        ax2 = gca;
...
elseif n_Mass == 4 
        ...
        h3 = openfig('FullVehicleLift3.fig','reuse'); % open figure
        ax3 = gca; % get handle to axes of figure

        h4 = openfig('FullVehicleLift4.fig','reuse');
        ax4 = gca;
...
elseif n_Mass == 6
        ...
        h5 = openfig('FullVehicleLift5.fig','reuse'); % open figure
        ax5 = gca; % get handle to axes of figure

        h6 = openfig('FullVehicleLift6.fig','reuse');
        ax6 = gca;
...
elseif n_Mass == 8
        ...
        h7 = openfig('FullVehicleLift7.fig','reuse'); % open figure
        ax7 = gca; % get handle to axes of figure

        h8 = openfig('FullVehicleLift8.fig','reuse');
        ax8 = gca;
...
elseif n_Mass == 10
        ...
        h9 = openfig('FullVehicleLift9.fig','reuse'); % open figure
        ax9 = gca; % get handle to axes of figure

        h10 = openfig('FullVehicleLift10.fig','reuse');
        ax10 = gca;
...
% SAVING AS A .FIG
name_figure = "FullVehicleLiftSubplots";
saveas(figure(n_figure), name_figure, 'fig');

% EXPORT FIGURE
exportgraphics(figure(n_figure), 'FullVehicleLiftSubplots.pdf', 'ContentType', 'vector')
exportgraphics(figure(n_figure), 'FullVehicleLiftSubplots.png', 'ContentType', 'vector')

% Moving file inside correct folder
movefile FullVehicleLiftSubplots.fig Output
movefile FullVehicleLiftSubplots.pdf Output
movefile FullVehicleLiftSubplots.png Output 
% -----------------------------------------------------------------